...
const areas = [
    ...
    "Advising on workplace rights and regulatory compliance",
    "Representing clients in employment-related disputes and negotiations",
    "Advising on terminations, redundancies, and severance packages",
    "Handling labour union and collective bargaining issues",
];

const sidebar = [
    { label: "All Practice Areas", to: "/practice-area" },
    { label: "Labour and Employment Law", to: "/labour" },
    { label: "Labour and Employment Law", to: "/advisory" },
                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>alancing Rights. Strengthening Workplaces.</span>
                        </motion.span>
                    </span>
                    ...
                    <motion.span
                        ...
                        variants={itemVariants}
                    >
                        The workplace is where business goals meet human rights. We provide legal clarity on contracts, compliance, and disputes to ensure fairness, protect interests, and maintain strong employer–employee relationships.
                    </motion.span>
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                At Kwame Akuffo & Co. Unlimited, we understand that employment matters can be both sensitive and complex. Our approach is to advise with balance—protecting legal rights while recognizing the realities of workplace dynamics. We combine clear advice with practical solutions that help employers remain compliant and empower employees to assert their rights.
                            </p>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span>Our Labour and Employment Law services include:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                We are committed to ensuring that workplace relationships remain lawful, fair, and sustainable.                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Employment issues often involve sensitive personal or corporate information. We handle every matter with discretion, protecting both professional reputations and individual rights while pursuing outcomes that are enforceable and fair.                            </p>
                        </motion.section>
                    </motion.article>
