                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>uidance Beyond the Fine Print</span>
                        </motion.span>
                    </span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span>Our Transactional Advisory practice includes:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                Our advisory work is designed to add value at every point of the transaction, not just at signing.
                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Your business decisions deserve both precision and discretion. We treat every matter with the highest level of confidentiality, ensuring sensitive details remain protected. Our advisory services are tailored to your goals, designed to minimize risk while maximizing opportunity.
                            </p>
                        </motion.section>
                    </motion.article>
