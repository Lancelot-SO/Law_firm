...
const areas = [
    ...
    "Advising on crisis response strategies for businesses and individuals",
    "Supporting clients in managing reputational and compliance challenges",
    "Coordinating multi-disciplinary teams in high-pressure situations",
];

const sidebar = [
    { label: "All Practice Areas", to: "/practice-area" },
    { label: "Crisis & Risk Management", to: "/crisis" },
                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>nticipating Risks. Managing Crises. Protecting Futures.</span>
                        </motion.span>
                    </span>
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                At Kwame Akuffo & Co. Unlimited, we understand that crises demand calm, clarity, and rapid response. Our approach is to combine legal expertise with strategic foresight, ensuring that risks are identified early and managed effectively. From regulatory threats to reputational issues, we provide clear plans of action that safeguard both immediate interests and long-term stability.
                            </p>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span>Our Crisis & Risk Management services include:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                Our goal is to turn potential vulnerabilities into manageable challenges — and, where possible, into opportunities.                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Crisis management often involves sensitive information and high stakes. We handle every matter with absolute discretion, ensuring that client confidentiality is never compromised while delivering strategies that protect both legal and reputational interests.
                            </p>
                        </motion.section>
                    </motion.article>
