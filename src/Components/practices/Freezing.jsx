...
const areas = [
    "Applying for freezing orders to preserve assets pending litigation",
    "Securing disclosure orders to obtain key information and documentation",
    "Advising on fraud-related asset tracing and recovery",
    "Coordinating cross-border enforcement where assets are held internationally",
    "Supporting clients in high-value commercial and financial disputes",
];

const sidebar = [
    { label: "All Practice Areas", to: "/practice-area" },
    { label: "Litigation and Dispute Resolution", to: "/litigation" },
    { label: "Freezing and Disclosure Orders", to: "/freezing" },
                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>ecuring Assets. Uncovering Truth.</span>
                        </motion.span>
                    </span>
                    ...
                    <motion.span
                        ...
                        variants={itemVariants}
                    >
                        In high-value disputes, timing and strategy make the difference. We help clients secure freezing and disclosure orders to protect assets and reveal critical information before it’s too late.
                    </motion.span>
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                At Kwame Akuffo & Co. Unlimited, we approach freezing and disclosure orders with speed, precision, and discretion. These powerful legal tools require careful preparation and strong advocacy, and our team ensures applications are grounded in evidence and designed for swift enforcement. Our goal is to prevent loss while strengthening our clients’ position in ongoing litigation or enforcement proceedings.</p>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span>Our services in this area include:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                We act quickly and decisively to ensure that assets are protected and evidence is preserved.
                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Matters involving freezing and disclosure orders are often urgent and highly sensitive. We handle every application with strict confidentiality, safeguarding client interests while pursuing remedies that are both effective and enforceable.                            </p>
                        </motion.section>
                    </motion.article>
