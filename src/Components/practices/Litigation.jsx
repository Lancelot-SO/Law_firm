...
const areas = [
    "Representing clients in civil and commercial hearings",
    "Handling appellate matters before higher courts",
    "Pursuing and defending review applications",
    "Managing complex, high-stakes disputes across multiple sectors",
    "Developing litigation strategies that balance legal precision with practical outcomes",
];
                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>trength in the Courtroom. Clarity in Strategy.</span>
                        </motion.span>
                    </span>
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                We combine deep legal insight with a results-driven mindset,
                                ensuring that each client receives personalized and strategic
                                representation. From negotiation to courtroom advocacy, our
                                focus is on resolving disputes efficiently and effectively.
                            </p>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span className="my-8">Our Litigation services include:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                Every case is pursued with thorough preparation and a clear focus on results.
                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Court cases often carry significant personal, financial, or reputational stakes. We safeguard our clients’ information with strict confidentiality while ensuring their interests are represented fearlessly and lawfully in every forum.
                            </p>
                        </motion.section>
                    </motion.article>
