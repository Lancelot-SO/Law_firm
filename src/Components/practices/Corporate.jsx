...
const areas = [
    ...
    "Supporting business restructuring, mergers, and acquisitions",
    "Advising boards and executive teams on strategic legal matters",
    "Providing ongoing legal counsel for operational and expansion needs",
];
                ...
                >
                    <span className="font-garamond font-normal leading-[70px] tracking-[-4%]">
                        ...
                        <motion.span
                            ...
                            variants={itemVariants}
                        >
                            <span className='font-garamond'>uilding Strong Businesses on Stronger Foundations.</span>
                        </motion.span>
                    </span>
                    ...
                    <motion.span
                        ...
                        variants={itemVariants}
                    >
                        Behind every successful business is a solid legal framework. From compliance to contracts to restructuring, we provide the clarity and strategy that keep companies secure, compliant, and prepared for growth.                    </motion.span>
            ...
            >
                ...
                <div className="absolute inset-0 flex flex-col px-6 space-y-12 mt-[150px]">
                    ...
                    <motion.p
                        ...
                        variants={itemVariants}
                    >
                        Behind every successful business is a solid legal framework. From compliance to contracts to restructuring, we provide the clarity and strategy that keep companies secure, compliant, and prepared for growth.                    </motion.p>
                    ...
                    >
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                At Kwame Akuffo & Co. Unlimited, we see ourselves as more than external advisors—we act as long-term legal partners. Our approach is grounded in proactive counsel, anticipating challenges before they become risks, and providing practical advice that supports both day-to-day operations and major corporate decisions.
                            </p>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <span>Our Corporate and Commercial Law practice includes:</span>
                        ...
                        <motion.section className='my-8' variants={itemVariants}>
                            <span>
                                We are committed to helping businesses not only operate lawfully but thrive strategically.
                            </span>
                        </motion.section>
                        ...
                        <motion.section className="mt-10" variants={itemVariants}>
                            ...
                            <div className="mt-3 h-px w-full bg-gray-200" />
                            <p className="mt-4 text-[15px] leading-7 text-[#222933]">
                                Every company has its own unique challenges, culture, and goals. We work closely with our clients to provide tailored solutions while safeguarding sensitive business information. Our duty is to ensure that your commercial interests are protected at every stage.                            </p>
                        </motion.section>
                    </motion.article>
